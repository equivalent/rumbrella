defmodule Rumbl.VideoControllerTest do
  use Rumbl.ConnCase
  alias Rumbl.Video
  @valid_attrs %{url: "http://youtub.", title: "vid", description: "a vid"}
  ...
  @tag login_as: "max"
  test "create user and redirects", %{conn: conn, user: user} do
  ...
  @tag login_as: "max"
  test "authorizes actoins against access by other users", %{user: owner, conn: conn} do
