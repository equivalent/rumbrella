defmodule Rumbl.AuthTest do
  ...
  test "login with a valid username and pass", %{conn: conn} do
    user = insert_user(%{username: "me", password: "secret99tt"})
    {:ok, conn} =
      Auth.login_by_username_and_pass(conn, "me", "secret99tt", repo: Repo)
  ...
  test "login with password mismatch", %{conn: conn} do
    _ = insert_user(%{username: "me", password: "secret3456"})
